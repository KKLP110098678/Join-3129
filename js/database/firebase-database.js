!(function (e, t) {
  ...
  try {
    !function () {
      ...
      function We(e, t) {
        return (
          "object" == typeof (t = setTimeout(e, t)) && t.unref && t.unref(),
          t
        );
      }
              ...
              : t.isEmpty() && ".priority" !== n
                ...
                : (g(
                  ...
                  this.updateImmediateChild(
                    n,
                    Nn.__childrenNodeConstructor.EMPTY_NODE.updateChild(
                      Ft(e),
                      t,
                    ),
                  ));
      ...
      function qi(e, t, n, r, i, o, s, a) {
        ...
        if (Bt(n)) c = l.updateFullNode(u.getNode(), r, null);
          ...
          ((h = Ft(n)),
            (r = u.getNode().getImmediateChild(s).updateChild(h, r)));
          c =
            ".priority" === s
      ...
      var wu =
        ((Cu.prototype.val = function () {
          return (
            U("DataSnapshot.val", 0, 0, arguments.length),
            this._delegate.val()
          );
        }),
      ...
      var bu =
        ...
        (Tu.prototype.toJSON = function () {
          return (
            U("Query.toJSON", 0, 1, arguments.length),
            this._delegate.toJSON()
          );
        }),
      ...
      var Eu,
        Iu =
          ...
          (Su.prototype.getKey = function () {
            return (
              U("Reference.key", 0, 0, arguments.length),
              this._delegate.key
            );
          }),
          ...
          (Su.prototype.push = function (e, t) {
            ...
            return (
              (r.then = e.then.bind(e)),
              (r.catch = e.catch.bind(e, void 0)),
              r
            );
          }),
      ...
      var ku =
        ...
        (Pu.prototype.goOnline = function () {
          return (
            U("database.goOnline", 0, 0, arguments.length),
            cu(this._delegate)
          );
        }),
        (Pu.ServerValue = {
