...
function moveTaskMenuTemplate(taskId, menuStatus) {
    ...
    return `
        <div class="move-task-menu d-none" id="moveMenu_${taskId}" onclick="event.stopPropagation()">
            <span class="move-menu-title">Move to</span>
            <div class="move-to-buttons">
                ${first ? moveOptionButtonTemplate(taskId, first, true) : ''}
                ${second ? moveOptionButtonTemplate(taskId, second, false) : ''}
            </div>
        </div>
    `;
}
    ...
    return `
        <div class="board-card" id="task_${task.id}"
            ...
            <div class="board-card-footer">
                <div class="board-card-avatars">${renderAssigneeIcons(task.assignees)}</div>
                <div class="board-card-priority">${renderPriorityIcon(task.priority)}</div>
            </div>
        </div>
    `;
}
