/**
 * Returns the complete add task form as an HTML string.
 * @returns {string} The HTML of the add task form.
 */
...
/**
 * Returns the template for the "Select All" option in the assigned-to dropdown.
 * @returns {string} HTML string of the select-all option.
 */
...
/**
 * Returns the template for the currently logged-in user in the dropdown.
 * @param {string} username - The username.
 * @param {string} initials - The initials of the user.
 * @returns {string} HTML string of the user option.
 */
...
/**
 * Returns the template for a contact in the assigned-to dropdown.
 * @param {{ name: string, initials: string, color: string }} contact - The contact.
...
/**
 * Returns the template for a subtask list entry.
 * @param {{ title: string, completed: boolean }} subtask - The subtask.
...
/**
 * Returns the template for the edit input field of a subtask.
 * @param {number} index - The index of the subtask.
 * @param {string} currentTitle - The current title of the subtask.
 * @returns {string} HTML string of the edit input field.
 */
...
/**
 * Returns the template for a contact in the edit assignee dropdown.
 * @param {{ name: string, initials: string, color: string }} contact - The contact.
...
/**
 * Returns the template for an edit subtask list entry.
 * @param {{ title: string, done: boolean }} subtask - The subtask.
 * @param {number} index - The index of the subtask.
 * @returns {string} HTML string of the entry.
 */
...
/**
 * Returns the template for the edit input field of an edit subtask.
 * @param {number} index - The index of the subtask.
